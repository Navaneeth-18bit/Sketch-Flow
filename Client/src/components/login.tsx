...
const Login: React.FC = () => {
                ...
                <div className="w-full max-w-md bg-white dark:bg-[#1e1e1e] p-8 rounded-2xl shadow-xl dark:shadow-none dark:border dark:border-[#2a2a2a] transition-all">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-blue-500/20"
                        >
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#121212] p-4 transition-colors relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-400/10 dark:bg-blue-400/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
            ...
            <div className="w-full max-w-md bg-white dark:bg-[#1e1e1e] p-8 rounded-3xl shadow-2xl shadow-gray-200/50 dark:shadow-none dark:border dark:border-[#2a2a2a] relative z-10 transition-all">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-400 dark:to-blue-500">SketchFlow</h1>
                ...
                <form onSubmit={isLogin ? handleLogin : handleSignUp} className="space-y-4 mb-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 px-4 mt-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-500/25 flex justify-center items-center"
                    >
                        {loading ? (
